...
<img src="logo smk mts.png" width="50px">
  <div class="container-fluid">
    <a class="navbar-brand" href="index1.php">Logout</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="petugas2.php">Home</a>
        </li>
        <li class="nav-item">
...
<li>
<form>
  <img src="a.jpg" width="400px">
  <h4 class="m-2">Tambah Buku</h4>
  <div class="m-2">
    <label for="judul" class="form-label">Judul Buku</label>
    <input type="text" class="form-control" id="judul">
  </div>
  <div class="m-2">
    <label for="des" class="form-label">Deskripsi Buku</label>
  ...
  <div class="m-2">
    <label for="file" class="form-label">E-Book</label>
